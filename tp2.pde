...
noStroke ();
fill (#F5F5F5);
triangle (0, 450, 0, 200, frameCount, 150); //triangulo izquierda arriba
fill (#C4C5C6);
triangle (600, 250, 600, 500, 600-150-frameCount, 600-150);
fill (#E3E7EA);
triangle (0, 0, 600, 0, 300, frameCount);
fill (#9B9B9B);
triangle (0, 600, 250, 600, 520, frameCount);
fill (#F5F5F5);
rect (0, 1280+370 -frameCount, width, height); 
fill (255);
triangle (0, 1280+370 -frameCount, 250, 1280+370 -frameCount, 520, frameCount);
